...
Route::get('/kpm/profiles', isAuthenticated(), permissionMiddleware('desa'), 'modules/kpm/profiles/index');
Route::get('/kpm/profiles/{id}', isAuthenticated(), permissionMiddleware('desa'), periodActive(), 'modules/kpm/profiles/view');
